...
abstract public class GraphView extends LinearLayout {
	...
	protected class GraphViewContentView extends View {
		...
		protected void onDraw(Canvas canvas) {
			...
			// vertical lines
			/*
			 * paint.setTextAlign(Align.LEFT); int vers = verlabels.length - 1;
			 * for (int i = 0; i < verlabels.length; i++) {
			 * paint.setColor(graphViewStyle.getGridColor()); float y =
			 * ((graphheight / vers) * i) + border; canvas.drawLine(horstart, y,
			 * width, y, paint); }
			 */
			...
			paint.setTextAlign(Align.CENTER);
			canvas.drawText(buildTitle(), (graphwidth / 2) + horstart,
					border - 4, paint);
	 ...
	 * 
	 * @return the title string, to be displayed above the graph
	 */
